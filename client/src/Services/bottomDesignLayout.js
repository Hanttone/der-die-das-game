    ...
    <svg
      ...
      <defs>
        ...
        <radialGradient
          ...
          r="0.5"
          gradientUnits="objectBoundingBox">
          <stop offset="0" stopColor="#ad41ce" />
          <stop
            offset="1"
            stopColor="#572167"
            stopOpacity="0.961"
        ...
        <linearGradient
          ...
          y2="1"
          gradientUnits="objectBoundingBox">
          <stop offset="0" stopColor="#3b35de" />
          <stop offset="1" stopColor="#1e1b6f" />
        </linearGradient>
        <linearGradient
          ...
          y2="1"
          gradientUnits="objectBoundingBox">
          <stop offset="0" stopColor="#41b9b0" />
          <stop offset="1" stopColor="#17767e" />
        </linearGradient>
      </defs>
      <g
        id="Group_2"
